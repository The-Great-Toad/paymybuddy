...
public class Messages {
    ...
    public static final String CONTACT_REMOVAL_SUCCESS = "%s was removed from your list of contacts";
    public static final String CONTACT_ADDED_SUCCESS = "%s was added to your list of contacts";
